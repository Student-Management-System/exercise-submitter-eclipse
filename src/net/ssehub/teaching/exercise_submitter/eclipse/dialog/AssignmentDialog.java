	...
	public AssignmentDialog(Shell parentShell,java.util.List<Assignment> assignments) {
	 ...
	 public Assignment getSelectedAssignment() {
	    ...
	    protected Control createDialogArea(Composite parent) {
	        ...
	        final org.eclipse.swt.widgets.List list = new org.eclipse.swt.widgets.List(container, SWT.BORDER | SWT.SINGLE | SWT.V_SCROLL);
	        list.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false,
	                false));
	    	   ...
	    	   public void widgetSelected(SelectionEvent event) {
	    		   int[] selections = list.getSelectionIndices();
	               		if(selections.length > 0) {
	               			...
	               			selectedAssignment = assignments.get(selections[0]);
